        ...
        <div class="row">
           ...
           <h4>CSE Faculty</h4>
                ...
                <div class="list-group">
                    ...
                    <a href="${contextRoot}/cse/results" class="list-group-item">Results of CSE Faculty As File</a>
                  
                    <a href="${contextRoot}/cse/notices" class="list-group-item">Notices of CSE Faculty As File</a>
